...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-!ls018)7m&add(=jt4p#!59dwhs$rj81!r!!hw%j0dd6ch!-i^')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', 'False').lower() == 'true'

ALLOWED_HOSTS = _split_env_list('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1')
CSRF_TRUSTED_ORIGINS = _split_env_list('DJANGO_CSRF_TRUSTED_ORIGINS', 'http://localhost,https://localhost')
